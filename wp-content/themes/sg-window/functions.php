...
function sgwindow_scripts_styles() {
	...
	wp_enqueue_style( 'sgwindow-style', get_stylesheet_uri(), array(), '05.08.2017' );
	...
	wp_enqueue_script( 'sgwindow-navigation', get_template_directory_uri() . '/js/navigation.js', array( 'jquery' ), '2017321', true );
...
function sgwindow_get_defaults() {
	...
	$defaults['column_background_url'] =  esc_url( get_template_directory_uri() ).'/img/back.jpg';	
		...
		<div class="nav-container top-1-navigation">						
			<?php if ( sgwindow_get_theme_mod( 'is_show_top_menu' ) == '1' ) : ?>
				<nav class="horisontal-navigation menu-1" role="navigation">
					...
					<?php wp_nav_menu( array( 'theme_location' => 'top1', 'menu_class' => 'nav-horizontal', 'fallback_cb' => 'sgwindow_empty_menu' ) ); ?>
			...
			<?php if ( '1' == sgwindow_get_theme_mod( 'is_show_secont_top_menu') ) : ?>
				...
				<div class="nav-container top-navigation">
					<nav class="horisontal-navigation menu-2" role="navigation">
						...
						<?php endif; ?>
						<span class="toggle"><span class="menu-toggle"></span></span>
						<?php wp_nav_menu( array( 'theme_location' => 'top2', 'menu_class' => 'nav-horizontal', 'fallback_cb' => 'sgwindow_empty_menu' ) ); ?>
